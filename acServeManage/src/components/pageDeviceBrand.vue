		  ...
		  <el-tabs :tab-position="tabPosition" style="min-height: 400px;background: #FFFFFF;padding: 10px;">
		    <el-tab-pane label="品牌管理">
			  ...
			  <el-table :data="tableInfo" style="width: 100%;margin: 10px 0;" max-height="600">
			    ...
			    <el-table-column prop="name" label="品牌名" width="120"></el-table-column>
	...
	export default {
		...
		methods: {
		    ...
		    getBrandList: function() {
				this.$axios.get(this.$localUrl + 'device/list/brand/'+this.currentPage+'/'+this.pageSizeNum).then((response) => {
